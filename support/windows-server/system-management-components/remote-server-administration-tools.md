...
_Applies to:_ &nbsp; Windows 10, version 21H2, Windows 10, version 21H1, Windows 10, version 20H2, Windows 10, version 20H1, Windows 10, version 1909, Windows 10, version 1903, Windows 10, version 1809, Windows 7 Service Pack 1, Windows Server 2019, Windows Server 2012 R2  
...
:::image type="content" source="./media/remote-server-administration-tools/turn-windows-features-on-or-off.png" alt-text="The Turn Windows features on or off option in Windows 7." border="false":::
...
:::image type="content" source="./media/remote-server-administration-tools/enable-rsat-tools-for-roles-and-features.png" alt-text="Enable the tools for the roles and features that you want to manage under Remote Server Administration Tools in Windows 7.":::
...
:::image type="content" source="./media/remote-server-administration-tools/select-features.png" alt-text="Select the tools that you want to install under Remote Server Administration Tools in Windows Server 2012 R2.":::
